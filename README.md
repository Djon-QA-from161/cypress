...
* Проверка приведения логина к строчным буквам (негативный сценарий, тест намеренно падает, фиксируя дефект)
...
Евгений Царев ([@Djon_elected](https://t.me/Djon_elected))
